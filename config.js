...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'DENETH-MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94762280384',
  alivepic: process.env.ALIVE_IMG || 'https://github.com/denethhansaka/DENETH-MD-New/blob/main/Images/DENETH-MD.jpg?raw=true',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY DENETH-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'DENETH',
  sessionName: process.env.SESSION_ID || 'gmlEQQgK#I3p8_RkDchmZYAjNsuKWATOwQIJjyJW6C_ReK7-4oMY',
